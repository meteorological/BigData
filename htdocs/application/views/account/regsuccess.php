	...
	<div class="wrap clearfix">
		...
		<div class="head_login fr">
            ...
            <p class="fl ueser_cnt">
            	<a href="login.html">$name</a><span>|</span><a href="<?= site_url('account/log_out')?>">退出</a>
            </p>
        </div>
	</div>
</div>
	...
	<div class="wrap clearfix">
		...
		<div class="info-complete">
			<div class="go-complete">
				<a href="perinfo.html" class="complete-pic">
		...
		<div class="reg-success-foot">
			暂不报名,<a href="<?= site_url('bigdata/index')?>">回到主页</a>
		</div>
	</div>
</div>
<!-- 网页尾部 -->
