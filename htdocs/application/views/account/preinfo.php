    ...
    <div class="fr">
        <div class="head_side fl">
            <ul class="main_nav clearfix">
                ...
                <li class="fl"><a href="<?= site_url('home/enter')?>">报名通道</a>
                </li>
            </ul>
        </div>
        <div class="head_login fr">
            ...
            <p class="fl ueser_cnt">
            	<a href="#">1777777777</a><span>|</span><a href="index.html">退出</a>
            </p>
        </div>
    </div>
  </div>
        ...
        <div class="wrap">
            ...
            <div class="personal-box-form">
                <div class="personal-form-list">
                    <form id="personal-form"  method="post" novalidate="novalidate">
                        <ul>
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <input type="text" placeholder="请输入真实姓名" class="nor-inp" id="name" name="name" required />
                                </div>
                            ...
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <input type="text" placeholder="请输入身份证号" class="nor-inp" id="idCard" name="idCard" required>
                                </div>
                                <div class="form1-info-check"></div>
                            </li>
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <input type="text" placeholder="请输入电子联系方式" class="nor-inp" id="email" name="email" required>
                                </div>
                                <div class="form1-info-check"></div>
                            </li>
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <div class="my-select university" style="width:350px;">
                                        ...
                                        <div class="my-option" style="display:none;">
                                            <dl>
                                                <dd value="1001">华东师范大学</dd>
                                                <dd value="1001">华东师范大学</dd>
                                                <dd value="1001">华东师范大学</dd>
                                                <dd value="1001">华东师范大学</dd>
                                                <dd value="1001">华东师范大学</dd>
                            ...
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <input type="text" id="master" name="master" placeholder="请输入专业名称" class="nor-inp" required>
                                </div>
                                <div class="form1-info-check"></div>
                            </li>
                            <li class="clearfix">
                                ...
                                <div class="form1-info">
                                    <input type="text" id="time" name="time" placeholder="例如2016" class="nor-inp" required>
                                </div>
                                <div class="form1-info-check"></div>
                            </li>
                            <li class="clearfix">
